        ...
        (event: React.ChangeEvent<HTMLInputElement>) => {
            ...
            if (file) {
                if (!file.type.startsWith('image/')) {
                    showToast(_('Please select an image file'), {
                        variant: 'error',
                    });
                    return;
                }
                ...
                showToast(_('Image selected successfully'), {
                    variant: 'success',
                });
            }
            ...
            <SFormRow>
                <SFormControl fullWidth>
                    ...
                    >
                        ...
                        <Tooltip
                            title="Enter a unique identifier for this passage"
                            arrow
                        >
                            <HelpOutline
                                sx={{
                    ...
                    <TextField
                        ...
                        error={
                            passageId.trim() !== '' &&
                            existingPassageIds.includes(passageId.trim())
                        }
                        helperText={
                            passageId.trim() !== '' &&
                            existingPassageIds.includes(passageId.trim())
            ...
            <SFormRow>
                <SFormControl fullWidth>
                    ...
                    >
                        ...
                        <Tooltip
                            title="Display title for the screen passage"
                            arrow
                        >
                            <HelpOutline
                                sx={{
            ...
            <SFormRow>
                <SFormControl fullWidth>
                    ...
                    >
                        ...
                        <Tooltip
                            title="Required - Character associated with this screen passage"
                            arrow
                        >
                            <HelpOutline
                                sx={{
                    ...
                    <Select
                        ...
                        onChange={(e) =>
                            handleInputChange('character', e.target.value)
                        }
                        size="small"
                        required
                        displayEmpty
            ...
            <SFormRow>
                <SFormControl fullWidth>
                    ...
                    >
                        ...
                        <Tooltip
                            title="Optional - Image to display on the screen"
                            arrow
                        >
                            <HelpOutline
                                sx={{
